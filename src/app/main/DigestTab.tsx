...
const DigestTab = async ({ currentTab }: DigestTabProps) => {
  const articleApiData = await getDigestArticleData(currentTab);
  return (
...
const getDigestArticleData = async (currentTab: string): Promise<ArticleType[]> => {
